...
import controlbiblioteca.accesoadatos.RolDAL;
import controlbiblioteca.accesoadatos.UsuarioDAL;
import controlbiblioteca.appweb.utils.*;
import controlbiblioteca.entidadesdenegocio.Rol;
import controlbiblioteca.entidadesdenegocio.Usuario;
...
public class UsuarioServlet extends HttpServlet {
    ...
    private Usuario obtenerUsuario(HttpServletRequest request) {
        ...
        if (accion.equals("login") || accion.equals("create") || accion.equals("cambiarpass")) {
            ...
            usuario.setConfirmPasswor_aux(Utilidad.getParameter(request, "confirmPassword_aux", ""));
