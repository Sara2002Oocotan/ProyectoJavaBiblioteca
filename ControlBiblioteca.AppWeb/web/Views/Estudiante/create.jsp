        ...
        <main class="container">   
            ...
            <form action="Estudiante" method="post">
                ...
                <div class="row">
                    ...
                    <div class="input-field col l4 s12">
                        <input  id="txtCarrera" type="text" name="carrera" required class="validate" maxlength="30">
                        <label for="txtCarrera">Carrera</label>
                    </div> 
                    <div class="input-field col l4 s12">
                        <input  id="txtCarnet" type="text" name="carnet" required class="validate" maxlength="30">
